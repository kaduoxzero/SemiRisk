...
```text
Windows 本机：http://localhost:8080/?v=cyber-20260609c
局域网访问：http://192.168.1.101:8080/?v=cyber-20260609c
...
1. 打开 `http://localhost:8080/?v=cyber-20260609c`。
2. 使用管理员账号登录。
...
```text
http://192.168.1.101:8080/?v=cyber-20260609c
```
